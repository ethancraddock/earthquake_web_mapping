...
Data was collected from USGS website where we were able to gather earthquake json data from the past 7 days.  Earthquake and tectonic plate data was then plotted on a leaflet map to share.
